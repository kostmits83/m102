...
<div>
    ...
    <div class="add-stock-to-portfolio">
        ...
        <?= $form->field($model, 'price')->label(false)->textInput(['placeholder' => $model->getAttributeLabel('price'), 'maxlength' => true, 'class' => 'form-control stock-add-to-portfolio__price js-stock-add-to-portfolio-price']) ?>
