...
<div class="user-profile">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 delete-account-message-wrapper">
            ...
            <div class="col-xs-12 delete-account-form-wrapper">
